...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col" bis_skin_checked="1">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left" bis_skin_checked="1">
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        <Image classNameName='bg-white' src={'/logo.png' } height={40} width={100} alt=''/>
        <span className="ml-3 text-xl">Tailblocks</span>
      </a>
      <p className="mt-2 text-sm text-gray-500">waer your &lt;confidence &lt; premium dresses</p>
      <p className="mt-2 text-sm text-gray-500">premium dress,hodies,and apparels</p>
    </div>
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center" bis_skin_checked="1">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4" bis_skin_checked="1">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">tshir</a>
          </li>
          <li>
  ...
  <div className="bg-gray-100" bis_skin_checked="1">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row" bis_skin_checked="1">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 sheikhwear.com — all right reserved
